"""
Add support for short arguments like -c for --coners and so on
"""
import argparse
import math
import json
...
def main():
    ...
    parser.add_argument('-F', '--format', type=str, choices=["svg", "rawr"], default="svg", help="Output format (svg or rawr) (default: svg)")

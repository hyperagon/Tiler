"""
Add an option to save the file as a RAWR (Glaxnimate) animation, use this as an example for 2x2 corners 4,
remember to PRECOMPOSE A TILE AND RE-USE ITs
{
    "assets": {
        "__type__": "Assets",
        "colors": {
                            ...
                            "shapes": [
                                {
                                    ...
                                    "shapes": [
                                        {
                                            ...
                                            "use": null,
                                            "uuid": "050bb62d-9774-4840-8911-3d70e4c1cbfb",
                                            "visible": true
                                        },
                                        {
                                            "__type__": "Stroke",
                                            ...
                                            "use": null,
                                            "uuid": "ae049b6e-70a7-4bc1-8cf3-70d600169d59",
                                            "visible": true,
                                            "width": {
                                                "value": 1
                                            }
                                        },
                                        {
                                            ...
                                            "uuid": "935a8170-41ed-4a32-817e-648c40b066d3",
                                            "visible": true
                                        }
                                    ],
                                    "transform": {
                                    ...
                                    "uuid": "cf4974be-b13e-4a5c-bf9a-30116679d5c9",
                                    "visible": true
                                }
                            ],
                            "transform": {
...
def generate_rawr_grid(width, height, tile_size, fill, stroke, stroke_width):
...
def main():
    ...
    if args.format.lower() == "svg":
        ...
        if args.corners != 4:
            print("RAWR format currently only supports corners=4")
            return
        
        glaxnimate_data = generate_rawr_grid(

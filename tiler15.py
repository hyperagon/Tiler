"""
The tiles outside of the document should be cut for all SVG or RAWR files. Don't remove FEATURES just cut Tiles outside of the WidthxHeight area.

this is a simple comparison, is it after the width + tile_size or before 0 - tile_size and the same for vertical. DO NOT USE CLIPPING

AFTER ROTATION, CUT AFTER ROTATION, not before
 
you're cutting too many triangles (corners=3) around 0, did you cut all above or near 0? DON'T DO THAT
"""
import argparse
import math
import json

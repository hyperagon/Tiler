"""
add new animations that do clear-fill-clear screen with tiles

ok get rid of opacity-radial and make opacity-spiral into opacity, also make tiles fade out like a spiral after they fill the screen
...
def get_animation_keyframes(row, col, rows, cols, direction, duration):
        ...
        for col in range(cols):
            ...
            if animate_enabled and animation_type and animation_type.startswith("scale"):
                ...
                if animation_type == "scale":
                    ...
                    # Directional scaling
                    key_times, values = get_animation_keyframes(row, col, rows, cols, animation_type, duration)
                    svg_content += f'<animateTransform attributeName="transform" type="scale" '
                ...
                # Get opacity animation values
                key_times, values = get_opacity_animation_values(row, col, rows, cols, animation_type, duration)
            ...
            if is_triangle_inside_after_rotation(x_main, y_main, size, inverted, width, height, rotation):
                ...
                if animate_enabled and animation_type and animation_type.startswith("scale-"):
                    precomp_layer["transform"]["scale"] = get_scale_keyframes(
                        animate_enabled, animation_type, row, col, rows, cols, duration
                    )

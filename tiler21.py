"""
SVG should duplicate the Tiles to improve performance and decrease file-size.
"""
"""
SVG should duplicate the Tiles to improve performance and decrease file-size.
"""
    ...
    for row in range(rows):
        for col in range(cols):
            ...
            if animate:
                ...
                svg_content += f'values="0;1;0" dur="1s" repeatCount="indefinite" additive="sum"/>\n'
                svg_content += f'<g transform="translate({-x},{-y})">\n'
...
def main():
    ...
    parser.add_argument('-a', '--animate', action='store_true', help="Add animation to the tiles")

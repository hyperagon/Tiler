...

{
    "assets": {
        ...
        "colors": {
            ...
            "name": "",
            "uuid": "c56ca71b-4097-4f3f-b937-d6cc8072977e",
            "values": [
            ]
        },
        "compositions": {
            ...
            "name": "",
            "uuid": "b15fa921-c243-432a-88a9-93715861ec7e",
            "values": [
                {
                    ...
                    "shapes": [
                        {
                                    ...
                                    "shapes": [
                                        {
                                            ...
                                            "use": null,
                                            "uuid": "04fd68bc-5434-4374-a02b-f846c9643b3b",
                                            "visible": true
                                        },
                                        {
                                            "__type__": "Stroke",
                                            ...
                                            "use": null,
                                            "uuid": "641debb8-1ff8-4bc3-a7ad-95a31ae2f697",
                                            "visible": true,
                                            "width": {
                                                "value": 1
                                            }
                                        },
                                        {
                                            ...
                                            "position": {
                                                "value": {
                                                    "x": 225.80976863753213,
                                                    "y": 169.54241645244218
                                                }
                                            },
                                            "reversed": false,
                                            "rounded": {
                                            ...
                                            "size": {
                                                "value": {
                                                    "height": 152.51413881748073,
                                                    "width": 179.1670951156812
                                                }
                                            },
                                            "uuid": "9d6e2303-3768-4c12-8cd9-a721ee3473c8",
                                            "visible": true
                                        }
                                    ],
                                    "transform": {
                                        ...
                                        "scale": {
                                            "value": {
                                                "x": 2.8574059009552,
                                                "y": 3.3534998893737793
                                            }
                                        }
                                    },
                                    "uuid": "5d34e723-6784-4081-af10-2be5f4eddafe",
                                    "visible": true
                                }
                            ],
                            "transform": {
                            ...
                            "uuid": "7d9993cd-6bb6-4315-aff8-b9f2ef5a55f2",
                            "visible": true
                        }
                    ],
                    "uuid": "31c6456f-7f73-4006-937a-3da3e6a8f688",
                    "visible": true,
                    "width": 512
                }
            ]
        ...
        "fonts": {
            "__type__": "FontList",
            "name": "",
            "uuid": "c54e67dc-fbfb-4d58-aa80-6dfefffa7095",
            "values": [
            ]
        },
        "gradient_colors": {
            ...
            "name": "",
            "uuid": "1bb82e0d-5b56-40fb-98ef-ed7f1c1cc357",
            "values": [
            ]
        },
        "gradients": {
            ...
            "name": "",
            "uuid": "fbf98398-7a6f-43bd-b1ea-00738131c708",
            "values": [
            ]
        },
        "images": {
            "__type__": "BitmapList",
            "name": "",
            "uuid": "4ff63a1c-abbd-43b7-9655-2737e6dd2d27",
            "values": [
            ]
        },
        "name": "",
        "uuid": "e4168876-50c7-4a39-aa58-44469168f3b4"
    },
    "format": {
        "format_version": 8,
...
def get_opacity_keyframes(animate_enabled, animation_type=None, row=0, col=0, rows=1, cols=1, duration=1.0):
    ...
    # For all opacity animations, we want a simple pattern like the example:
    # 0.0: start at 0 (invisible)
    # 0.5: reach 1 (fully visible)
    # 1.0: back to 0 (invisible)
    
    return {
        "keyframes": [
            {
                "after": {"x": 1, "y": 1},  # Changed from simple number to object
                "before": {"x": 0, "y": 0},  # Changed from simple number to object
                "time": 0,
                "value": 0
            },
            {
    ...
    for row in range(rows):
        for col in range(cols):
            ...
            if animate_enabled and animation_type and (animation_type.startswith("scale") or animation_type == "scale"):
                ...
                # Simple fade in and out for all tiles: 0 -> 1 -> 0

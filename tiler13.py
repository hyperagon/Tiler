"""
Final challenge, make sure that all RAWR animated tile functions support rotation, that the rotations FILL the document and ERASE ALL OUTLIERS
"""
import argparse
import math
import json
...
def generate_triangular_tiling(width, height, size, rotation, fill, stroke, stroke_width, animate=False):
    ...
    horizontal_spacing = tile_size / 2  # Horizontal distance between triangle centers

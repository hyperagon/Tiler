"""
on glaxnimate the position of the composition has to be centered properly on X, it should not be centered at 0,0 but width/2,height/2 meaning that, right now it is wrongly on the left when using the move animation instead of the center

Testing with python tiler32.py -c 4 -r 45 -w 1280 -H 720 -f "#008800" -t "#004400" -a move-d -F rawr -D 4. if it was "-F html" it would work perfectly
"""
import argparse
import math
import json
